...
/// validation select one
                    ...
                    var nowDate = new Date();
                                 ...
                                 $.ajax({
                                              ...
                                              success: function (data) {
                                                  if (data['success']) {
                                                      ...
                                                      toastr.success("Mark Online Paid successfully","Mail");
                                                      location.reload();
                                                  } else if (data['error']) {
                                                    toastr.error("Sorry Invoice Mark as not Online Paid","Mail");
                                                  } else {
                                                      alert('Whoops Something went wrong!!');
                                                  }
                                              },
                      ...
                      //// mark invoice Stripe paid
                      $(document).ready(function () {
                          $('#markCashPaid').on('click', function(e) {
                              var allVals = [];  
                              var join_selected_values =[];
                                $(".sub_chk:checked").each(function() {  
                                    allVals.push($(this).attr('data-id'));
                                 ...
                                 $.ajax({
                                              ...
                                              success: function (data) {
                                                  if (data['success']) {
                                                      ...
                                                      toastr.success("Mark Cash Paid successfully","Mail");
                                                      location.reload();
                                                  } else if (data['error']) {
                                                    toastr.error("Sorry Invoice Mark as not Cash Paid","Mail");
                                                  } else {
                                                      alert('Whoops Something went wrong!!');
                                                  }
                                              },
