@extends('layouts.app')
@section('content')
<form action="/userUpdate/{{ auth()->user()->id }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="row-class">
        ...
        <div class="row user-profile-row2">
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control client-input input-border" maxlength="50" value="{{ auth()->user()->fname }}" name="fname" id="firstN" placeholder="First Name" required>
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group">
                    <label class="user-input-label">Last Name</label>
                    <input type="text" class="form-control client-input input-border" maxlength="50" name="lname" value="{{ auth()->user()->lname }}" placeholder="Last Name"  required>
                  </div>
              </div>
          </div><!-- end row -->
          ...
          <div class="row user-profile-row">
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control client-input input-border" minlength="10" maxlength="10" value="{{ auth()->user()->phone_no }}" name="phone_no" placeholder="Phone-Number">
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group">
                    <label class="user-input-label">Email</label>
                    <input type="email" class="form-control client-input input-border {{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ auth()->user()->email }}" placeholder="Email" required>
                    @if ($errors->has('email'))
          ...
          <div class="row user-profile-row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control client-input input-border" value="{{ auth()->user()->company_name }}" name="company_name" placeholder="Company">
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <label class="user-input-label">Company Logo</label>
                <div class="form-group">
                  <button type="button" class="btn logo-btn" id="selectFile">@if(auth()->user()->avatar) Change @else Choose @endif Logo</button>
                  ...
                  <div class="form-group">
                    <label class="user-input-label">State</label>
                      <select name="state" id="state" class="form-control input-border">
                          ...
                          <option value="{{$state->name}}" {{$state->name == auth()->user()->state  ? 'selected' : ''}}>{{$state->name}}</option>
                          @endforeach
                      </select>
                  </div>
              </div>
        ...
        <div class="row user-profile-row">
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control client-input input-border" value="{{ auth()->user()->city}}" name="city" placeholder="City">
                </div>
              </div>
              <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                  <div class="form-group">
                     <label class="user-input-label">ZipCode</label>
                    <input type="text" class="form-control client-input input-border" name="zipcode" value="{{ auth()->user()->zipcode }}" placeholder="ZipCode">
                  </div>
              </div>
          </div><!-- end row -->
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                  <label class="user-input-label">CIN/GSTIN<span>  (Put here your CIN or GSTIN registration number which will show up on invoice Ex. CIN-234234234XXX)</span></label>
                   <input type="text" class="form-control client-input input-border" name="gstin_number" value="{{ auth()->user()->gstin_number }}" placeholder="CIN / GSTIN Number">
                </div>
              </div>
          </div><!-- end row -->
          ...
          <div class="row user-profile-row" style="margin-bottom: 25px;">
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="form-group">
                  ...
                  <textarea name="address" id="textarea-input" rows="3" placeholder="Address..." class="form-control input-border">{{ auth()->user()->address }}</textarea>
                </div>
              </div>
          </div><!-- end row -->
