...
<div class="col-4 col-sm-5 col-md-4 col-lg-3 col-xl-2" style="padding-top: 15px;">
  <h5>USER</h5>
    ...
    <div class="search-bar">
        <form action="/admin/search" method="GET" id="SearchData" role="search">  
          ...
          <div class="col-md-2 search-icon-div m-t-15" style="padding-left: 0px;">
              ...
              <div class="col-md-9">
                 <a href="/admin"><button type="button" class="clear-btn-icon" id="clear-btn" style="margin-top: -3px;"><img src="/images/delete-invoice-icon.svg" width="34px"> <br><span class="clear-icon-title">Clear</span></button></a>
            </div>         
          </div>
        </form>
    </div> <!-- end row -->
