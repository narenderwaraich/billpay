                          ...
                          <div class="col-md-12 col-sm-12 result-status">
                            ...
                            <table class="table table-hover on-mob-scroll-table-full">
                                ...
                                <tbody>
                                    ...
                                    <tr class="" data-href='/user/{{$userData->id}}/view' style="cursor: pointer;">
                                        <td>{{ $userData->id }}</td>
                                        ...
                                        <td>
                                        @if($userData->mail_subscribe)
                                            <a href="/user/mail-subscribe/{{$userData->id}}" class="btn btn-warning on-mob-table-btn">Unsubscribe</a>
                                        @else
                                            <a href="/user/mail-subscribe/{{$userData->id}}" class="btn btn-success on-mob-table-btn">Subscribe</a>
                                        @endif
                                    </tr>
                                    @endforeach
                                </tbody>
