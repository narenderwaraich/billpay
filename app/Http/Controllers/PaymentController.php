...
class PaymentController extends Controller
{
    ...
    public function showPayment()
    {
        ...
        foreach ($payments as $payment) {
        	...
        	$client_first_name = Clients::where('id',$invoice->client_id)->first()->fname;
        	$client_last_name = Clients::where('id',$invoice->client_id)->first()->lname;
        	$client_name = $client_first_name.' '.$client_last_name;
        	$payment->user = $client_name;
        }
